...
#define m_set_bg_threads(get_state, get_size, set_state, set_size)      heap_manager_set_bg_threads(get_state, get_size, set_state, set_size)
#else
...
#define m_set_bg_threads(get_state, get_size, set_state, set_size)      memkind_arena_set_bg_threads(get_state, get_size, set_state, set_size)
#endif
...
MEMKIND_EXPORT int memkind_set_bg_threads(bool *read_state, size_t read_sz, bool *enable, size_t sz)
{
    return m_set_bg_threads(read_state, read_sz, enable, sz);
}
