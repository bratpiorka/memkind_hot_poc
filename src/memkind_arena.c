...
int memkind_arena_set_bg_threads(bool *read_state, size_t read_sz, bool *enable, size_t sz)
{
    int err = jemk_mallctl("background_thread", (void *)&(*read_state), &read_sz, &(*enable), sz);
    if (err) {
