...
struct heap_manager_ops {
    ...
    int (*heap_manager_set_bg_threads)(bool *get_state, size_t get_size, bool *set_state, size_t set_size);
};
...
int heap_manager_set_bg_threads(bool *read_state, size_t read_sz, bool *enable, size_t sz)
{
    return get_heap_manager()->heap_manager_set_bg_threads(read_state, read_sz, enable, sz);
}
